...
func keccak256(data *string) *string { return nil }

//go:wasmimport sdk crypto.sp1_verify_groth16
func sp1VerifyGroth16(proof *string, publicInputs *string, sp1VkeyHash *string, groth16Vk *string, vkRoot *string) *string { return nil }
